...
![9-Accounts in the Chart of Accounts](https://lopez-coll.com/wp-content/uploads/image-2-1024x489.png)
...
![AP Open Invoice Journal with 9* as offset account](https://lopez-coll.com/wp-content/uploads/image-3-1024x506.png)
...
![Fixed Asset Acquisition journal with Asset account as offset](https://lopez-coll.com/wp-content/uploads/image-4-1024x507.png)

The result of posting this journal, and from a General Ledger perspective, we would have "net zero" vouchers in the GL.

![Voucher of a Fixed Asset Acquisition journal with Asset account as offset](https://lopez-coll.com/wp-content/uploads/image-5-1024x507.png)
