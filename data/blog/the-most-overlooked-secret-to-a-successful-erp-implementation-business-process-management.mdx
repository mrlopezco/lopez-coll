...
Welcome to the first post in a series dedicated to a topic that I believe is the single most important factor in a successful Microsoft Dynamics implementation. It’s not about the tech, the features, or the budget. It’s all about the process. Over the next few articles, we’ll build a practical, no-nonsense guide to using BPM in software projects to ensure your project delivers real value.
...
-   **Business Process Mapping:** This is the act of visually documenting the "to-be" business processes that will be supported by the new software. It’s about creating a clear, shared understanding of how work will get done in the new world.
...
It’s a great question, and the answer is yes, but with a major warning. The catalog is a fantastic resource. Think of it as a library or an encyclopedia of standard processes, much like the APQC process frameworks. It can give you ideas and a starting point.

But you cannot take it and apply it directly to your client. Here’s why:
...
Using the standard catalog without tailoring it is a shortcut that often leads to a system that feels foreign and clunky to the end-users. It’s a tool, not the answer.
...
In our next post, we’ll get our hands dirty. We'll talk about the fundamental building blocks of a good process map and I'll introduce you to BPMN 2.0—a simple but powerful visual language that will become an essential tool in your project toolkit.