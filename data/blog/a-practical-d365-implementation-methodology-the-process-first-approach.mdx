...
1.  **Understand the Current State:** Let's be realistic—most projects don't have the budget for a massive 'as-is' analysis project. But the consultant leading a process workshop *must* understand the current state, its pain points, and its hidden complexities.
