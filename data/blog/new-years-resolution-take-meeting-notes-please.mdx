...
draft: false
layout: PostLayout
summary: Managing the results and findings from meetings is a point we have been constantly neglecting. Be honest, everybody dislikes documentation. Me too. Lets discuss how we can improve this.
---
